...
> **플랫폼 선택 근거와 접근성 요건은 [platform-accessibility.md](platform-accessibility.md).**
> 요약: 웹(PWA) 단독은 ① 계산대 앞 3초 ② 오프라인 ③ D2 무인 결제 셋을 동시에 내려놔야 해서 배제.
> 대신 `react-native-web`으로 **「보여주기」 한 화면만 설치 없는 웹 체험판**으로 내어 채널 도구로 쓴다.
> 목업 팔레트에서 **대비 실패 2건 적발** — `#A3947C`(2.06:1) · 11px `#8A7B66`(3.69:1). 정정값은 해당 문서 §5.1.
