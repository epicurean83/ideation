...
Everything else (the <!--gen:count:phases-->13<!--/gen-->-phase methodology, <!--gen:count:blocks-->106<!--/gen--> blocks, <!--gen:count:channels-->29<!--/gen--> channels, <!--gen:count:stat_sources-->460<!--/gen-->+ sources, the
